...
@interface UncheckedViewController ()<UITableViewDataSource,UITableViewDelegate>
@property(nonatomic,strong)UITableView *tableview;
@property (nonatomic,strong)NSMutableArray * dataArr;
@end

@implementation UncheckedViewController
...
- (void)InfoNotificationAction:(NSNotification *)notification{
    ...
    if (notification.userInfo) {
        ...
        if ([_dataArr[0][@"orderstatus"] integerValue] == 0) {
            [_tableview reloadData];
        }
//        if (_hidenSegmentBlock) {
//            self.hidenSegmentBlock([_dataArr[0][@"orderstatus"] integerValue]);
//        }
...
-(void)searchLeaseOrderData{
    ...
    NSDictionary * dic = @{@"orderstatus":@"0"};
