...
@interface WuLiuOrderHeaderTitleView()
...
@end
@implementation WuLiuOrderHeaderTitleView
- (NSMutableArray *)btns
{
    if(_btns==nil)
    {
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    {
        [self addButtonWithTitle:@"货物订单"];
        [self addButtonWithTitle:@"车型订单"];
