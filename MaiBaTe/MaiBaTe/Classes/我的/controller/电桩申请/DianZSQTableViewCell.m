...
//    _timeLabel.text = [NSString stringWithFormat:@"%@ %@ %@ %@",data.provinceid,data.cityid,data.areaid,data.address];
    _annotateLabel.text = [NSString stringWithFormat:@"备注:%@",data.note];
...
//    [_bgview addSubview:_timeLabel];
    ...
    _bigdelBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [_bigdelBtn addTarget:self action:@selector(cutBtnClick) forControlEvents:UIControlEventTouchUpInside];
    [_bgview addSubview:_bigdelBtn];
...
//    .heightIs(10);
    ...
    _bigdelBtn.sd_layout
    .widthIs(50)
    .topSpaceToView(_line2View,0)
    .rightSpaceToView(_bgview,0)
    .heightIs(40);
