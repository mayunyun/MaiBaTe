...
- (void)setScoresUIView{
    ...
    UIImageView *bgimage = [[UIImageView alloc]initWithFrame:CGRectMake(0, 64, UIScreenW, 150*MYWIDTH)];
...
- (UITableView *)tableview{
    if (_tableview == nil) {
        _tableview = [[UITableView alloc]initWithFrame:CGRectMake(0, 64+195*MYWIDTH, UIScreenW, UIScreenH-64-195*MYWIDTH)];
