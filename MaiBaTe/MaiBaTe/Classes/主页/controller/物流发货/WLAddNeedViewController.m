...
- (void)viewDidLoad {
    ...
    UIButton *Upbut = [[UIButton alloc]initWithFrame:CGRectMake(0, UIScreenH-55*MYWIDTH, UIScreenW, 55*MYWIDTH)];
...
- (UITableView *)tableview{
    if (_tableview == nil) {
        _tableview = [[UITableView alloc]initWithFrame:CGRectMake(0, 64, UIScreenW, UIScreenH-64-55*MYWIDTH)];
        ...
        UIView *head = [[UIView alloc]initWithFrame:CGRectMake(0, 0, UIScreenW, 30*MYWIDTH)];
        UIView *baihead = [[UIView alloc]initWithFrame:CGRectMake(15*MYWIDTH, 20*MYWIDTH, UIScreenW-30*MYWIDTH, 10*MYWIDTH)];
        ...
        UIView *baifoot = [[UIView alloc]initWithFrame:CGRectMake(15*MYWIDTH, 0, UIScreenW-30*MYWIDTH, 10*MYWIDTH)];
