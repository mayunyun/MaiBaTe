...
- (void)setWithUIview{
    ...
    self.ImageScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 64, UIScreenW, 130*MYWIDTH)];
    if (statusbarHeight>20) {
        self.ImageScrollView.frame = CGRectMake(0, 88, UIScreenW, 130*MYWIDTH);
    }
    self.ImageScrollView.backgroundColor = [UIColor whiteColor];
    self.ImageScrollView.showsHorizontalScrollIndicator = NO;
    self.ImageScrollView.showsVerticalScrollIndicator = NO;
    self.ImageScrollView.pagingEnabled = YES;
    self.ImageScrollView.contentSize = CGSizeMake(UIScreenW*self.dataArr.count, 0);
    ...
    for (int i = 0; i<self.dataArr.count; i++) {
        ...
        UILabel *titleLab = [[UILabel alloc]initWithFrame:CGRectMake(UIScreenW*i, 0, UIScreenW, 20*MYWIDTH)];
        ...
        UIImageView * carimage = [[UIImageView alloc]initWithFrame:CGRectMake(UIScreenW/2-120*MYWIDTH+UIScreenW*i, 20*MYWIDTH, 240*MYWIDTH, 100*MYWIDTH)];
    ...
    UIButton *youBut = [[UIButton alloc]initWithFrame:CGRectMake(UIScreenW - 50*MYWIDTH, self.ImageScrollView.top + 50*MYWIDTH, 30*MYWIDTH, 30*MYWIDTH)];
    ...
    //
    UIView *bgview1 = [[UIView alloc]initWithFrame:CGRectMake(0, self.ImageScrollView.bottom, UIScreenW, 180*MYWIDTH)];
    ...
    UIView *xian3 = [[UIView alloc]initWithFrame:CGRectMake(15*MYWIDTH, xian1.bottom + 15*MYWIDTH, UIScreenW-30*MYWIDTH, 1)];
    xian3.backgroundColor = UIColorFromRGB(0xEEEEEE);
    [bgview1 addSubview:xian3];
    
    UIImageView * zouimage = [[UIImageView alloc]initWithFrame:CGRectMake(xian1.left-45*MYWIDTH, xian3.bottom+20*MYWIDTH, 90*MYWIDTH, 90*MYWIDTH)];
    zouimage.image = [UIImage imageNamed:@"jiagedise"];
    [bgview1 addSubview:zouimage];
    
    UILabel *addLab = [[UILabel alloc]initWithFrame:CGRectMake(UIScreenW/2-15*MYWIDTH, xian3.bottom+50*MYWIDTH, 30*MYWIDTH, 30*MYWIDTH)];
    addLab.text = @"+";
    addLab.textAlignment = NSTextAlignmentCenter;
    addLab.textColor = UIColorFromRGB(0x333333);
    addLab.font = [UIFont systemFontOfSize:25];
    [bgview1 addSubview:addLab];
    
    UIImageView * youimage = [[UIImageView alloc]initWithFrame:CGRectMake(xian2.left-45*MYWIDTH, xian3.bottom+20*MYWIDTH, 90*MYWIDTH, 90*MYWIDTH)];
    youimage.image = [UIImage imageNamed:@"jiagedise"];
    ...
    UIView *bgview2 = [[UIView alloc]initWithFrame:CGRectMake(15*MYWIDTH, bgview1.bottom+25*MYWIDTH, UIScreenW-30*MYWIDTH, 80*MYWIDTH)];
    bgview2.backgroundColor = [UIColor whiteColor];
    bgview2.layer.cornerRadius = 5;
    bgview2.layer.borderColor = UIColorFromRGB(0xEEEEEE).CGColor;//设置边框颜色
    ...
    titleLab1.text = @"  费用说明";
    titleLab1.textColor = UIColorFromRGB(0x888888);
    titleLab1.backgroundColor = UIColorFromRGB(0xEEEEEE);
    ...
    titleLab2.textColor = UIColorFromRGB(0x888888);
    titleLab2.font = [UIFont systemFontOfSize:12];
    [bgview2 addSubview:titleLab2];
    
    UIView *bgview3 = [[UIView alloc]initWithFrame:CGRectMake(15*MYWIDTH, bgview2.bottom+18*MYWIDTH, UIScreenW-30*MYWIDTH, 140*MYWIDTH)];
    bgview3.backgroundColor = [UIColor whiteColor];
    bgview3.layer.cornerRadius = 5;
    bgview3.layer.borderColor = UIColorFromRGB(0xEEEEEE).CGColor;//设置边框颜色
    ...
    titleLab3.text = @"  额外需求";
    titleLab3.textColor = UIColorFromRGB(0x888888);
    titleLab3.backgroundColor = UIColorFromRGB(0xEEEEEE);
    ...
    _titleLab4.textColor = UIColorFromRGB(0x888888);
