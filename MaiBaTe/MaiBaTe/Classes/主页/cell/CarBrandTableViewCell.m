...
- (void)setData:(CarBrandModel *)data
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"厂商指导价:%.2f万",[_data.groupprice floatValue]];
    ...
    [hintString addAttribute:NSForegroundColorAttributeName value:UIColorFromRGB(MYColor) range:range1];
