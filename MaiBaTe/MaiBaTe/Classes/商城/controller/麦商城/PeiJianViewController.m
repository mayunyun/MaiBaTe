...
- (void)loadNewData{
    ...
    [HTNetWorking postWithUrl:URLStr refreshCache:YES params:nil success:^(id response) {
        ...
        for (NSDictionary *dicId in Arr) {
            if ((![[dicId objectForKey:@"id"] isEqualToString:@"552"])&&(![[dicId objectForKey:@"id"] isEqualToString:@"537"])&&(![[dicId objectForKey:@"id"] isEqualToString:@"538"])) {
