...
//        }
    ...
    _hejiLab.text = [NSString stringWithFormat:@"合计:%.2f元",[model.totalmoney floatValue]];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.headerImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/%@/%@",PHOTO_ADDRESS,model.folder,model.autoname]] placeholderImage:[UIImage imageNamed:@"default_img_cell"]];
    ...
    cell.priceLab.text = [NSString stringWithFormat:@"%.2f元",[model.price floatValue]];
