...
- (void)viewDidLoad {
    ...
    Size_i = 0;
    [self tableview];
    _webView = [[UIWebView alloc]initWithFrame:CGRectMake(0, 35, UIScreenW, 1)];
...
- (UITableView *)tableview{
    if (_tableview == nil) {
        ...
        _collectionView = [[CollectionDetailHeaderView alloc]initWithFrame:CGRectMake(0, 0, UIScreenW, 220*MYWIDTH)];
        ...
        UIView *food = [[UIView alloc]initWithFrame:CGRectMake(0, 0, UIScreenW, 50)];
    ...
    [HTNetWorking postWithUrl:URLStr refreshCache:YES params:params success:^(id response) {
        ...
        if (!IsEmptyValue(_dataArr)) {
            ...
            if (!IsEmptyValue(model.note)) {
                ...
                [_webView loadHTMLString:[NSString stringWithFormat:@"%@%@",model.note,linkCss] baseURL:[NSURL URLWithString:@"http://192.168.1.235:8080"]];
            }else{
                _webView.height = 0;
            }
        }
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    _webView.frame = CGRectMake(_webView.frame.origin.x,_webView.frame.origin.y, UIScreenW, documentHeight);
    [_tableview reloadData];
